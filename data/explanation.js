var introduction = '<center>Welcome to the study "Deceptive opinion spam 2018"!</center></br></br></br>Please do this task in one of the following web-browsers: Google Chrome, Firefox, or Safari.';
...
// manipulations
var general_instructions1 = '<p>In this experiment, you are asked to write two product reviews.</p> <p>In the prolific prescreening, you indicated that you recently purchased an electronic device online. You rated that product as either very bad (1 or 2 stars) or very good (5 stars).</br> The reviews you will be writing are about that product. One of the reviews will be truthful and corresponds to your initial rating. For the other review, we ask you to imagine that you gave the product a rating which is opposite of your truthful rating (5 stars instead of 1 or 2, or vice versa).</br> You will be asked to provide a link to the electronic device you purchased and to answer some general questions about reviews.</p> <p>Please follow the instructions carefully!</p>';
...
var instructions_neg1 = '<p>Based on your prescreening on Prolific you indicated that you recently purchased an electronic device online and rated that product with 1 or 2 stars (i.e. very bad).</p>';
...
var outro_en = 'Your participation code: <span id=partcode style="color: red">9871NO</span></br></br>' +
	...
	'In order to validate your participation, it is necessary that you provide your Prolific ID below in the left hand-field and confirm your participation code on the right.</br></br>' +
	'Click on SEND to finish this task (this may take some time, please wait until you are re-directed to prolific).</br>' +

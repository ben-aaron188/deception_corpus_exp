...
// manipulations
var general_instructions1 = '<p>In this experiment, you are asked to write two product reviews.</p> <p>In the prolific prescreening, you indicated that you recently purchased an electronic device online. You rated that product as either very bad (1 star) or very good (5 stars). The reviews you will be writing are about that product. One of the reviews will be truthful and corresponds to your initial rating. For the other review, we ask you to imagine that you gave the product a rating which is opposite of your truthful rating (5 stars instead of 1 or vice versa). After you finished writing the reviews you will be asked to provide a link to the electronic device you purchased and to answer some general questions about reviews.</p> <p>Please follow the instructions carefully!</p>';
...
var pre_input_pos = "<p>Now imagine that you are very satisfied with the purchased product and give this product a 5 star (very good) rating, instead of your actual 1 star rating.</p>";
var pre_input_neg = '<p>Now imagine that you are not satisfied with your purchased product and you give this product a 1 star (very bad) rating, instead of your actual 5 star rating.</p>';

var instructions_inputfield_pos_truthful = '<p>Please write an <b>honest, positive review</b> about your purchased product according to your 5 star rating.</p> <p>The review will have to be at least 75 words and you will not be able to copy and paste text into the answer box.</p>';
var instructions_inputfield_neg_truthful = '<p>Please write an <b>honest, negative review</b> about your purchased product according to your 1 star rating.</p> <p>The review will have to be at least 75 words and you will not be able to copy and paste text into the answer box.</p>';
var instructions_inputfield_pos_deceptive = '<p>Please write a <b>fake, positive review</b> about your purchased product according to your 1 star rating.</p> <p>The review will have to be at least 75 words and you will not be able to copy and paste text into the answer box.</p>';
var instructions_inputfield_neg_deceptive = '<p>Please write a <b>fake, negative review</b> about your purchased product according to your 5 star rating.</p> <p>The review will have to be at least 75 words and you will not be able to copy and paste text into the answer box.</p>';
